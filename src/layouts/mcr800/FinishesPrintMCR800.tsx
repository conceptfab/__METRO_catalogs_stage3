...
// === Copied verbatim from MaterialsMCR800 so the print preview uses the
 ...
 *
 * Preview area is a direct copy of the Customization (MaterialsMCR800) schema:
 ...
 */
export default function FinishesPrintMCR800({
  data,
  configurator,
  previewMode,
}: Props) {
        ...
        <div className="print-section-content finishes-print-content">
          ...
          {hasConfigurator && (randomFrame || randomDesktop) ? (
            <div className="finishes-print-preview">
              {/* === Preview block — verbatim layering schema from MaterialsMCR800 === */}
              <figure
