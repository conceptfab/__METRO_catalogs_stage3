...
function useHeroMCR800ViewModel(data: HeroData) {
...
function renderHeroMCR800({
  ...
  wrapperFlexClasses,
  wrapperStyle,
}: ReturnType<typeof useHeroMCR800ViewModel>) {
  return (
    <section
      id="cover"
...
const HeroMCR800 = ({ data }: HeroMCR800Props) => renderHeroMCR800(useHeroMCR800ViewModel(data));

export default HeroMCR800;
